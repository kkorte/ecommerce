...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ URL::route('hideyo.client-address.index', $client->id) }}">orders</a></li>
 ...
 <table id="datatable" class="table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="col-md-2">{{{ trans('hideyo::table.created-at') }}}</th>
                    <th class="col-md-1">{{{ trans('hideyo::table.client') }}}</th>
                    <th class="col-md-2">{{{ trans('hideyo::table.status') }}}</th>
                    <th class="col-md-1">{{{ trans('hideyo::table.payment-method') }}}</th>
                    <th class="col-md-1">{{{ trans('hideyo::table.sending-method') }}}</th>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                oTable = $('#datatable').DataTable({
                    "processing": true,
                    "serverSide": true,
                     "ajax": "{{ URL::route('hideyo.client-order.index', $client->id) }}",

...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            <li><a href="{{ URL::route('admin.general-setting.index') }}">Overview <span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="{{ URL::route('admin.general-setting.create') }}">Edit</a></li>
        </ul>
    </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <ol class="breadcrumb">
            <li><a href="/admin">Dashboard</a></li>
            <li><a href="{{ URL::route('admin.general-setting.index') }}">Tax rates</a></li>  
        ...
        {!! Form::model($generalSetting, array('method' => 'put', 'route' => array('admin.general-setting.update', $generalSetting->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-5">
                    ...
                    <a href="{!! URL::route('admin.general-setting.index') !!}" class="btn btn-large">Cancel</a>
                </div>
            </div>
        {!! Form::close() !!}
    </div>

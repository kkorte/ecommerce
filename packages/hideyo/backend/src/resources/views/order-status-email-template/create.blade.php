...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="{!! URL::route('admin.order-status-email-template.create') !!}">Create</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <div class="row">
            <div class="col-md-8">
    {!! Form::open(array('route' => array('admin.order-status-email-template.store'), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

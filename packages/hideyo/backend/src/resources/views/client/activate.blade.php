...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        @include('admin._partials.client-tabs', array('clientActivate' => true))
    </div>
...
<div class="row">
    <div class="col-md-12">
					...
					{!! Form::model($client, array('route' => array('admin.client.activate', $client->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="{{ URL::route('admin.shop.create') }}">Create</a></li>
        </ul>
    </div>
    ...
    {!! Form::open(array('route' => array('admin.shop.store'), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-5">
                ...
                <a href="{!! URL::route('admin.shop.index') !!}" class="btn btn-large">Cancel</a>
            </div>
        </div>

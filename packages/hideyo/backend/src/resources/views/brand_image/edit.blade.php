...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <a href="{!! URL::route('admin.brand.{brandId}.images.index', $brand->id) !!}" class="btn btn-green btn-icon icon-left pull-right">back to images<i class="entypo-plus"></i></a>

        <h2>Brand <small>images edit</small></h2>
        {!! Notification::showAll() !!}
        <hr/>
        {!! Form::model($brandImage, array('method' => 'put', 'route' => array('admin.brand.{brandId}.images.update', $brand->id, $brandImage->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

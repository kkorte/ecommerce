...
<div class="row">
    ...
    {!! Form::open(array('route' => array('hideyo.extra-field.{extraFieldId}.values.store', $extraField->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-5">
                ...
                <a href="{!! URL::route('hideyo.extra-field.{extraFieldId}.values.index', $extraField->id) !!}" class="btn btn-large">Cancel</a>
            </div>
        </div>

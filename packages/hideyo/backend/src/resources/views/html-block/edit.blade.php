...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="{{ URL::route('admin.html-block.create') }}">Edit</a></li>
        </ul>
    </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{!! URL::route('admin.html-block.edit', $htmlBlock->id) !!}">edit</a></li>
            <li><a href="{!! URL::route('admin.html-block.edit', $htmlBlock->id) !!}">{!! $htmlBlock->title !!}</a></li>
        ...
        {!! Form::model($htmlBlock, array('method' => 'put', 'route' => array('admin.html-block.update', $htmlBlock->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

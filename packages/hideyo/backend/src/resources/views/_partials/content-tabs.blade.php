<ul class="nav nav-sidebar"><!-- available classes "right-aligned" -->
    ...
    <li>
        <a href="{!! URL::route('admin.content.index', $content->id) !!}">
            Overview
        </a>
    </li>
    ...
    <li>
    @endif
        <a href="{{ URL::route('admin.content.edit', $content->id) }}">
    ...
    <li>
    @endif
        <a href="{{ URL::route('admin.content.edit_seo', $content->id) }}">
            <span class="visible-xs"><i class="entypo-gauge"></i></span>
    ...
    <li>
    @endif
        <a href="{!! URL::route('admin.content.{contentId}.images.index', $content->id) !!}">

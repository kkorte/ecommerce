        <ul class="nav nav-sidebar"><!-- available classes "right-aligned" -->
            ...
            <li>
                <a href="{!! URL::route('admin.recipe.index', $recipe->id) !!}">
                    Overview
                </a>
            </li>
            @if(isset($recipeEdit))
            ...
            <li>
            @endif
                <a href="{{ URL::route('admin.recipe.edit', $recipe->id) }}">
            ...
            <li>
            @endif
                <a href="{{ URL::route('admin.recipe.edit_seo', $recipe->id) }}">
                    <span class="visible-xs"><i class="entypo-gauge"></i></span>
            ...
            <li>
            @endif
                <a href="{!! URL::route('admin.recipe.{recipeId}.images.index', $recipe->id) !!}">

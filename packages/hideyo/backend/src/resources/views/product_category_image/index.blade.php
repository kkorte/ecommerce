...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <a href="{{ URL::route('hideyo.product-category.{productCategoryId}.images.create', $productCategory->id) }}" class="btn btn-success pull-right">upload image<i class="entypo-plus"></i></a>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                oTable = $('#datatable').DataTable({
                    "processing": true,
                    "serverSide": true,
                   "ajax": "{{ URL::route('hideyo.product-category.{productCategoryId}.images.index', $productCategory->id) }}",

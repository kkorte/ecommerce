    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary tab-content">
            ...
            <div class="panel-body">    
                    ...
                    <div class="col-md-12">
						{!! Form::model($productImage, array('method' => 'put', 'route' => array('hideyo.product.image.update', $product->id, $productImage->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

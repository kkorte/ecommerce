...
class InvoiceTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('invoice', function (Blueprint $table) {
            ...
            $table->foreign('delivery_invoice_address_id')->references('id')->on('invoice_address')->onDelete('set null');
            $table->foreign('bill_invoice_address_id')->references('id')->on('invoice_address')->onDelete('set null');
        });

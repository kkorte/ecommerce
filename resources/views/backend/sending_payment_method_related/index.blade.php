...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            <li class="active"><a href="{{ URL::route('sending-payment-method-related.index') }}">Overview <span class="sr-only">(current)</span></a></li>
        </ul>
    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                oTable = $('#datatable').DataTable({
                    "processing": true,
                    "serverSide": true,
                 "ajax": "{{ URL::route('sending-payment-method-related.index') }}",

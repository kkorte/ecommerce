...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{!! URL::route('product.{productId}.images.index', $product->id) !!}">product amount series</a></li>
                      <li class="active">create combination</li> 
        </ol>
<a href="{!! URL::route('product.{productId}.product-amount-series.index', $product->id) !!}" class="btn btn-green btn-icon icon-left pull-right">back to overview<i class="entypo-plus"></i></a>

<h2>Product amount series  <small>create</small></h2>
<hr/>
        ...
        <div class="panel panel-primary tab-content">
            ...
            <div class="panel-body">    
                    ...
                    <div class="col-md-12">
					    ...
					    {!! Form::open(array('route' => array('product.{productId}.product-amount-series.store', $product->id), 'method'=>'POST', 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
					        ...
					        <div class="form-group">
					            <div class="col-sm-offset-3 col-sm-5">
					                ...
					                <a href="{!! URL::route('product.{productId}.product-amount-series.index', $product->id) !!}" class="btn btn-large">Cancel</a>
					            </div>
					        </div>

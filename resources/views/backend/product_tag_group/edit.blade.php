...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        {!! Form::model($productTagGroup, array('method' => 'put', 'route' => array('product-tag-group.update', $productTagGroup->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

...
<div class="row">
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		<ol class="breadcrumb">
			...
			<li><a href="{!! URL::route('product.product-combination.index', $product->id) !!}">combinations</a></li>
				...
				<div class="panel panel-primary tab-content">
					...
					<div class="panel-body">    
						...
						<div class="col-md-12">
							...
							{!! Form::model($productCombination, array('method' => 'put', 'route' => array('product.product-combination.update', $product->id, $productCombination->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

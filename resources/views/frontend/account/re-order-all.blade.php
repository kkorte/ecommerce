        ...
        <div class="small-15 medium-12 large-15 columns">
            <nav aria-label="You are here:" role="navigation">
                <ul class="breadcrumbs">
                    ...
                    <li class="active"><a href="#">Favoriete producten herbestellen</a></li>
    ...
    <div class="row">
        <div class="small-15 medium-15 large-15  columns">
            <div class="re-order order-block">
                <h3>Favoriete producten herbestellen</h3>
                @if($orderProducts)
                <p>Je kan hieronder nogmaals bestelde producten uit het verleden in de winkwagen plaatsen, mits het op voorraad is.</p>

...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="{!! URL::route('extra-field.{extraFieldId}.values.index', $extraFieldDefaultValue->extra_field_id) !!}">Values</a></li>
        ...
        {!! Form::model($extraFieldDefaultValue, array('method' => 'put', 'route' => array('hideyo.extra-field.{extraFieldId}.values.update', $extraFieldDefaultValue->extra_field_id, $extraFieldDefaultValue->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
                ...
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-5">
                        ...
                        <a href="{!! URL::route('extra-field.{extraFieldId}.values.index', $extraFieldDefaultValue->extra_field_id) !!}" class="btn btn-large">Cancel</a>
                    </div>
                </div>

    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <ol class="breadcrumb">
          ...
          <li><a href="{!! URL::route('news.index') !!}">News</a></li>
            ...
            <li><a href="{!! URL::route('news.{newsId}.images.index', $news->id) !!}">images</a></li>
          <li class="active">upload image</li>            
        </ol>

        <a href="{!! URL::route('news.{newsId}.images.index', $news->id) !!}" class="btn btn-danger pull-right">back to images<i class="entypo-plus"></i></a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
    			    ...
    			    {!! Form::open(array('route' => array('hideyo.news.{newsId}.images.store', $news->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
    			        ...
    			        <div class="form-group">
    			            <div class="col-sm-offset-3 col-sm-5">
    			                ...
    			                <a href="{!! URL::route('news.{newsId}.images.store', $news->id) !!}" class="btn btn-large">Cancel</a>
    			            </div>
    			        </div>

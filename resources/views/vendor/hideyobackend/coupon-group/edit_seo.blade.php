...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        @include('admin._partials.content-group-tabs', array('contentGroupEditSeo' => true))
    </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">

        <ol class="breadcrumb">
            <li><a href="/"><i class="entypo-folder"></i>Dashboard</a></li>
            <li><a href="{!! URL::route('admin.content-group.index') !!}">Content</a></li>
            <li><a href="{!! URL::route('admin.content-group.edit', $contentGroup->id) !!}">edit</a></li>
            <li><a href="{!! URL::route('admin.content-group.edit', $contentGroup->id) !!}">{!! $contentGroup->title !!}</a></li>
        ...
        {!! Form::model($contentGroup, array('method' => 'put', 'route' => array('admin.content-group.update', $contentGroup->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-5">
                ...
                <a href="{!! URL::route('admin.content-group.index') !!}" class="btn btn-large">Cancel</a>
            </div>
        </div>

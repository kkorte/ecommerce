...
<head>
	...
	html { font-family: 'FontAwesome'; font-size:14px;}
	body { 
		font-family: 'FontAwesome'; 
		font-size:14px; 
		padding:10px; 
	}
	.contact {text-align:right; width:100%; padding-bottom:60px;  }
	...
	.products th { text-transform:uppercase;  font-size:11px; text-align:left; padding:10px;  background-color: #D1005D; color:white; }
	.page-break {
	...
	.title a {color:black;}
	.address {text-align:left; width:100%; padding-bottom:30px; padding-top:30px; }
...
<body>
	...
	@include('admin.order.bodypdf-wholesale')
	@else
	@include('admin.order.bodypdf')
	@endif

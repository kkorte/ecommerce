...
<div class="  pull-right">
    <a href="{{ URL::route('admin.order.index') }}" class="btn btn-danger  pull-right">Back to overview</a>
</div>
...
$(document).ready(function(){
      ...
      insert: '<div class="icheck_line-icon"></div>' + label_text
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                {!! Form::open(array('route' => array('admin.order.add-product'), 'files' => true, 'class' => 'form-inline validate')) !!}
  ...
  {!! Form::select('product_combination_id', array('0' => '-- selecteer --') + $product['combinations'], $product['id'], array("data-url" => "/order/change-product-combination/".$product['id'], "class" => "form-control custom-selectbox change-product-combination")) !!}
                        ...
                        <td>
                            <a href="{{ URL::route('admin.order.delete-product', $product['id']) }}" class="delete-product-{!! $product['id'] !!} btn btn-danger">verwijder</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            {!! Form::open(array('route' => array('admin.order.store'), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

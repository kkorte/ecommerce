<ul class="nav nav-sidebar"><!-- available classes "right-aligned" -->
    ...
    <li>
        <a href="{!! URL::route('admin.brand.index', $brand->id) !!}">
            Overview
        </a>
    </li>
    @if(isset($brandEdit))
    ...
    <li>
    @endif
        <a href="{{ URL::route('admin.brand.edit', $brand->id) }}">
    ...
    <li>
    @endif
        <a href="{{ URL::route('admin.brand.edit_seo', $brand->id) }}">
            <span class="visible-xs"><i class="entypo-gauge"></i></span>
    ...
    <li>
    @endif
        <a href="{!! URL::route('admin.brand.{brandId}.images.index', $brand->id) !!}">

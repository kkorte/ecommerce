...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{!! URL::route('recipe.edit', $recipe->id) !!}">{!! $recipe->title !!}</a></li>
            <li class="active">images</li>           
        </ol>

        <a href="{{ URL::route('recipe.{recipeId}.images.create', $recipe->id) }}" class="btn btn-success pull-right">upload image<i class="entypo-plus"></i></a>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                oTable = $('#datatable').DataTable({
                    "processing": true,
                    "serverSide": true,
                   "ajax": "{{ URL::route('recipe.{recipeId}.images.index', $recipe->id) }}",

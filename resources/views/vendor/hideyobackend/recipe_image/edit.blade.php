...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <ol class="breadcrumb">
          ...
          <li><a href="{!! URL::route('recipe.index') !!}">Recipes</a></li>
            <li><a href="{!! URL::route('recipe.edit', $recipe->id) !!}">edit</a></li>
            <li><a href="{!! URL::route('recipe.edit', $recipe->id) !!}">{!! $recipe->title !!}</a></li>
            <li><a href="{!! URL::route('recipe.{recipeId}.images.index', $recipe->id) !!}">images</a></li>
          <li class="active">edit image</li> 
        </ol>

        <a href="{!! URL::route('recipe.{recipeId}.images.index', $recipe->id) !!}" class="btn btn-green btn-icon icon-left pull-right">back to images<i class="entypo-plus"></i></a>

        <h2>Recipe <small>images edit</small></h2>
        {!! Notification::showAll() !!}
        <hr/>
        {!! Form::model($recipeImage, array('method' => 'put', 'route' => array('hideyo.recipe.{recipeId}.images.update', $recipe->id, $recipeImage->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-5">
                ...
                <a href="{!! URL::route('recipe.{recipeId}.images.store', $recipe->id) !!}" class="btn btn-large">Cancel</a>
            </div>
        </div>

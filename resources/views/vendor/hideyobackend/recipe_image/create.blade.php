...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <a href="{!! URL::route('recipe.{recipeId}.images.index', $recipe->id) !!}" class="btn btn-danger pull-right">back to images<i class="entypo-plus"></i></a>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
    			    ...
    			    {!! Form::open(array('route' => array('hideyo.recipe.{recipeId}.images.store', $recipe->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

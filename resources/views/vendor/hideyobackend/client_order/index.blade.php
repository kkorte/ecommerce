...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ URL::route('admin.client.{clientId}.addresses.index', $client->id) }}">orders</a></li>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                oTable = $('#datatable').DataTable({
                    "processing": true,
                    "serverSide": true,
                             "ajax": "{{ URL::route('admin.client.{clientId}.order.index', $client->id) }}",

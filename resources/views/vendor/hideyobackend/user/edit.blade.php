...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            <li><a href="{!! URL::route('admin.user.index') !!}">Overview <span class="sr-only">(current)</span></a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        {!! Notification::showAll() !!}
           ...
           {!! Form::model($user, array('method' => 'put', 'route' => array('admin.user.update', $user->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

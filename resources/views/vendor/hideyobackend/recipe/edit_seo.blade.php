...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        @include('admin._partials.recipe-tabs', array('recipeEditSeo' => true))
    </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">

        <ol class="breadcrumb">
            <li><a href="/"><i class="entypo-folder"></i>Dashboard</a></li>
            <li><a href="{!! URL::route('admin.recipe.index') !!}">Content</a></li>
        ...
        {!! Form::model($recipe, array('method' => 'put', 'route' => array('admin.recipe.update', $recipe->id), 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator')) !!}

...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <a href="{!! URL::route('product-category.{productCategoryId}.images.index', $productCategory->id) !!}" class="btn btn-danger pull-right">back to images<i class="entypo-plus"></i></a>

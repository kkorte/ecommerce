    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        {!! Form::model($product, array('route' => array('product.store-copy', $product->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::multiselect2('subcategories[]', $productCategories->toArray(), $product->subcategories->lists('id')->toArray()) !!}
                </div>
            </div>
            ...
            @include('hideyo_backend::_fields.buttons', array('cancelRoute' => 'product.index'))          
    </div>
</div>
@stop

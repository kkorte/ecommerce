...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{!! URL::route('product.{productId}.images.index', $product->id) !!}">images</a></li>
                      <li class="active">upload image</li> 
        </ol>
<a href="{!! URL::route('product.{productId}.images.index', $product->id) !!}" class="btn btn-green btn-icon icon-left pull-right">back to images<i class="entypo-plus"></i></a>
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary tab-content">
            ...
            <div class="panel-body">    
                    ...
                    <div class="col-md-12">
						{!! Form::model($productImage, array('method' => 'put', 'route' => array('hideyo.product.{productId}.images.update', $product->id, $productImage->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
					 ...
					 <input type="hidden" name="_token" value="{!! Session::getToken() !!}">
					        ...
					        <div class="form-group">
					            <div class="col-sm-offset-3 col-sm-5">
					                ...
					                <a href="{!! URL::route('product.{productId}.images.store', $product->id) !!}" class="btn btn-large">Cancel</a>
					            </div>
					        </div>

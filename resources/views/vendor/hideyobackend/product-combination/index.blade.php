...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		<a href="{{ URL::route('product.{productId}.product-combination.create', $product->id) }}" class="btn btn-green btn-success pull-right">create combination<i class="entypo-plus"></i></a>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                oTable = $('#datatable').DataTable({
                    "processing": true,
                    "serverSide": true,
                   "ajax": "{{ URL::route('product.{productId}.product-combination.index', $product->id) }}",

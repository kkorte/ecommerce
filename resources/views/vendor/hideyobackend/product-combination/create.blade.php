...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{!! URL::route('product.{productId}.images.index', $product->id) !!}">combinations</a></li>
                      <li class="active">create combination</li> 
        </ol>
<a href="{!! URL::route('product.{productId}.product-combination.index', $product->id) !!}" class="btn btn-danger btn-icon icon-left pull-right">back to overview<i class="entypo-plus"></i></a>
        ...
        <div class="panel panel-primary tab-content">
            ...
            <div class="panel-body">    
                    ...
                    <div class="col-md-12">
					    ...
					    {!! Form::open(array('route' => array('hideyo.product.{productId}.product-combination.store', $product->id), 'method'=>'POST', 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
            				...
            				@include('hideyo_backend::_fields.buttons', array('cancelRoute' => 'product.{productId}.product-combination.index', 'cancelRouteParameters' => $product->id))
					        ...
					        <script type="text/javascript">
					            $(document).ready(function() {
								    ...
								    hasBeenClicked = true;
								    $.getJSON( "{{ URL::route('product.{productId}.product-combination.create', $product->id) }}", { attribute_group_id: this.value } )
								        .done(function( data ) {
								    ...
								    if (!hasBeenClicked) {
		    							...
		    							$.getJSON( "{{ URL::route('product.{productId}.product-combination.create', $product->id) }}", { attribute_group_id: defaultValue } )
								        .done(function( data ) {
											//clear the current content of the select
											$select.html('');
											//iterate over the data and append a select option

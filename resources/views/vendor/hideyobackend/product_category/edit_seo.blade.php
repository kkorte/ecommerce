...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        @include('admin._partials.product-category-tabs', array('productCategoryEditSeo' => true))
    </div>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <div class="row">
            <div class="col-md-12">
                {!! Form::model($productCategory, array('method' => 'put', 'route' => array('admin.product-category.update', $productCategory->id), 'files' => true, 'class' => 'form-horizontal', 'data-toggle' => 'validator')) !!}

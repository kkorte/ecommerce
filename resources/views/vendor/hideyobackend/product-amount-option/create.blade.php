...
<div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{!! URL::route('admin.product.{productId}.images.index', $product->id) !!}">product amount options</a></li>
        ...
        <div class="panel panel-primary tab-content">
            ...
            <div class="panel-body">    
                    ...
                    <div class="col-md-12">
					    ...
					    {!! Form::open(array('route' => array('admin.product.{productId}.product-amount-option.store', $product->id), 'method'=>'POST', 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}

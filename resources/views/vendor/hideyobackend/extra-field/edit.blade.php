...
<div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="{!! URL::route('admin.extra-field.edit', $extraField->id) !!}">Edit</a></li>
            <li><a href="{!! URL::route('admin.extra-field.{extraFieldId}.values.index', $extraField->id) !!}">Values</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        {!! Form::model($extraField, array('method' => 'put', 'route' => array('admin.extra-field.update', $extraField->id), 'files' => true, 'class' => 'form-horizontal form-groups-bordered validate')) !!}
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-5">
                ...
                <a href="{!! URL::route('admin.extra-field.index') !!}" class="btn btn-large">Cancel</a>
            </div>
        </div>

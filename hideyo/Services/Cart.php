...
class Cart
{
    ...
    protected $_sending_method_rule = array();
    protected $_country_id = 0;
    ...
    protected $_pick_up_location_code;
    protected $_pick_up_location_address = array();
    protected $_delivery_date = null;
    protected $_delivery_period = null;
    protected $_delivery_time = null;
    protected $_delivery_extra_cost_ex_tax = 0;
    protected $_delivery_extra_cost_inc_tax = 0;
    ...
    public function updateSendingMethodRule($sendingMethodRule)
    {
        if($sendingMethodRule AND  !empty($this->_sending_method['sending_method_price_rules'])) {
            $this->_country_id = $sendingMethodRule['country_id'];
            $this->_sending_method_rule = $sendingMethodRule;
            $this->_sending_method_cost_ex_tax =  $sendingMethodRule['price_details']['orginal_price_ex_tax'] + $this->_delivery_extra_cost_ex_tax;
            $this->_sending_method_cost_inc_tax = $sendingMethodRule['price_details']['orginal_price_inc_tax'] + $this->_delivery_extra_cost_inc_tax;

            if($sendingMethodRule['no_price_from']) {
                if ($this->_sending_method['wholesale']) {
                    $freeSending = ( $sendingMethodRule['no_price_from'] - $this->_product_total_ex_tax);
                } else {
                    $freeSending = ( $sendingMethodRule['no_price_from'] - $this->_product_total_inc_tax);
                }
    ...
    public function updateSendingMethod($sendingMethod)
    {
        if (isset($sendingMethod['id'])) {
            ...
            $this->_country_id = 0;
            $this->_sending_method_rule = array();
            ...
            $this->_sending_method_cost_ex_tax = $sendingMethod['price_details']['orginal_price_ex_tax'] + $this->_delivery_extra_cost_ex_tax;
            $this->_sending_method_cost_inc_tax = $sendingMethod['price_details']['orginal_price_inc_tax']  + $this->_delivery_extra_cost_inc_tax;

            if($sendingMethod['no_price_from']) {
    ...
    public function totals()
    {
        if ($this->_products) {
            ...
            $this->_totals['country_id'] = $this->_country_id;
            ...
            $this->_totals['pick_up_location_code'] = $this->_pick_up_location_code;
            $this->_totals['pick_up_location_address'] = $this->_pick_up_location_address;

            $this->_totals['delivery_date'] = $this->_delivery_date;
            $this->_totals['sent_date'] = $this->_sent_date;
            $this->_totals['delivery_time'] = $this->_delivery_time;
            $this->_totals['delivery_period'] = $this->_delivery_period;
            $this->_totals['discount_ex'] = $this->_discount_ex;
    ...
    public function summary()
    {
        ...
        if ($this->_products) {
            ...
            $this->updateSendingMethodRule($this->_sending_method_rule);
    ...
    {
        return $this->_delivery_date = $deliveryDate;
    }
    ...
    public function addPickUpLocationCode($locationCode)
    {
        return $this->_pick_up_location_code = $locationCode;
    }


    public function getPickUpLocationCode()
    {
        return $this->_pick_up_location_code;
    }



    public function addPickUpLocationAddress($locationAddress)
    {
        return $this->_pick_up_location_address = $locationAddress;
    }


    public function getPickUpLocationAddress()
    {
        return $this->_pick_up_location_address;
    }


    public function addSentDate($sentDate)
    {
        return $this->_sent_date = $sentDate;
    }
    ...
    public function addDeliveryPeriod($deliveryPeriod)
    {

        $this->_delivery_extra_cost_ex_tax = 0;
        $this->_delivery_extra_cost_inc_tax = 0;


        if($deliveryPeriod == 'Evening') {

            $this->_delivery_extra_cost_ex_tax = 1.0331;
            $this->_delivery_extra_cost_inc_tax = 1.25;

        } elseif ($deliveryPeriod == 'Sunday') {
            $this->_delivery_extra_cost_ex_tax = 4.1322;
            $this->_delivery_extra_cost_inc_tax = 5;
        }

        $this->updateSendingMethod($this->_sending_method);

        return $this->_delivery_period = $deliveryPeriod;
    }


    public function getDeliveryPeriod()
    {
        return $this->_delivery_period;
    }

    public function addDeliveryTime($deliveryTime)
    {
        return $this->_delivery_time = $deliveryTime;
    }

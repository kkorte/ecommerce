...
class CartCondition {
    ...
    /**
     * apply condition to total or subtotal without tax
     *
     * @param $totalOrSubTotalOrPrice
     * @return float
     */
    public function applyConditionWithoutTax($totalOrSubTotalOrPrice)
    {
        ...
        return $this->apply($totalOrSubTotalOrPrice, 0); 
    }

    /**
     * apply condition to total or subtotal with tax
     *
     * @param $totalOrSubTotalOrPrice
     * @return float
     */
    public function applyConditionWithTax($totalOrSubTotalOrPrice)
    {
        return $this->apply($totalOrSubTotalOrPrice, $this->getAttributes()['data']['price_details']['original_price_inc_tax']);
    }
    ...
    protected function validate($args)
    {
        ...
        // if( $validator->fails() )
        // {
        //     throw new InvalidConditionException($args);
        // }
    }
}